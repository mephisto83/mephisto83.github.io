...
MEPH.define('MEPH.qrcode.version.Version', {
    requires: ['MEPH.qrcode.BitMatrix', 'MEPH.qrcode.version.ECBlocks', 'MEPH.qrcode.version.ECB'],
    initialize: function (versionNumber, alignmentPatternCenters, ecBlocks1, ecBlocks2, ecBlocks3, ecBlocks4) {
        var me = this;
        me.versionNumber = versionNumber;
        me.alignmentPatternCenters = alignmentPatternCenters;
        me.ecBlocks = new Array(ecBlocks1, ecBlocks2, ecBlocks3, ecBlocks4);
        ...
        me.totalCodewords = total;

        Object.defineProperty(me, 'VersionNumber', {
            get: function () {
                return me.versionNumber;
            }
        });

        Object.defineProperty(me, 'AlignmentPatternCenters', {
            get: function () {
                return me.alignmentPatternCenters;
            }
        });
        Object.defineProperty(me, 'TotalCodewords', {
            get: function () {
                return me.totalCodewords;
            }
        });
        Object.defineProperty(me, 'DimensionForVersion', {
            get: function () {
                return 17 + 4 * me.versionNumber;
            }
        });
    ...
    getECBlocksForLevel: function (ecLevel) {
        var me = this;
        return me.ecBlocks[ecLevel.ordinal()];
    },
    buildFunctionPattern: function () {
        var me = this, dimension, bitMatrix;
        dimension = me.DimensionForVersion;
        ...
        // Alignment patterns
        var max = me.alignmentPatternCenters.length;
        for (var x = 0; x < max; x++) {
            var i = me.alignmentPatternCenters[x] - 2;
            for (var y = 0; y < max; y++) {
                if ((x == 0 && (y == 0 || y == max - 1)) || (x == max - 1 && y == 0)) {
                    // No alignment patterns near the three finder paterns
                    continue;
                }
                bitMatrix.setRegion(me.alignmentPatternCenters[y] - 2, i, 5, 5);
            }
        }
    ...
    statics: {
        ...
        decodeVersionInformation: function (versionBits) {
            ...
            var bestVersion = 0, me = this;
            for (var i = 0; i < Version.VERSION_DECODE_INFO.length; i++) {
                var targetVersion = Version.VERSION_DECODE_INFO[i];
                // Do the version info bits match exactly? done.
                if (targetVersion == versionBits) {
                    return me.getVersionForNumber(i + 7);
                }
            ...
            if (bestDifference <= 3) {
                return me.getVersionForNumber(bestVersion);
            }
    ...
    var Version = MEPH.qrcode.version.Version,
        ECBlocks = MEPH.qrcode.version.ECBlocks,
        ECB = MEPH.qrcode.version.ECB;
