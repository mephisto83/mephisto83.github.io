...
Vex.Flow.Music.prototype.getNoteParts = function (noteString, octave) {
...
Vex.Flow.Music.prototype.getNoteValue = function (noteString) {
    var octave = noteString.split("/")[1];
    var value = Vex.Flow.Music.noteValues[noteString.split("/")[0]];
    if (value == null)
        throw new Vex.RERR("BadArguments", "Invalid note name: " + noteString);

    return value.int_val + (octave * 12);
}
